...
import type { WakeFieldBackend, WakeFieldMetrics, WakeFieldMode, WakeFieldRenderInput } from "./types";
...
export class WebGlWakeFieldBackend implements WakeFieldBackend {
