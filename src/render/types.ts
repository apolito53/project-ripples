...
export type RenderSettingsSnapshot = {
  ...
  readonly fieldPaletteId: "profile" | "reference" | "legacy-neon";
...
export type RenderRaceTrackMaskSnapshot = {
  readonly width: number;
  readonly height: number;
...
export type RenderRaceTrackWallSnapshot = {
  readonly version: number;
...
export type RenderTrainingMarkerSnapshot = {
...
export type RenderTrainingSnapshot = {
  readonly enabled: boolean;
  ...
  readonly marker: RenderTrainingMarkerSnapshot;
};
