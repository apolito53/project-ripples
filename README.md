...
a bright inner orb, orbiting motes, and subtle trails. They wait until the
avatar runs through them, then detonate into a wider pulse and flat disc burst
of sparks.
...
- `src/echoZones.ts` owns persistent collectible Echo-column lights, bright orb
  lights, orbiting sparkle trails, and their run-through trigger detection.
